/**
 * BusinessCategorySelector Component
 *
 * A reusable select dropdown component for business categories that automatically
...
import { useActiveMerchantCategories } from '@/features/merchants/hooks';
...
const BusinessCategorySelector = React.forwardRef<
  HTMLSelectElement,
...
BusinessCategorySelector.displayName = 'BusinessCategorySelector';
